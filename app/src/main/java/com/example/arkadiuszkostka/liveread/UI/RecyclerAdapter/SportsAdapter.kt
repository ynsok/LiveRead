...
class SportsAdapter(private var listner: OnItemPosition): RecyclerView.Adapter<SportsAdapter.ViewHolder>() {
    var data: List<SportsEntry> by Delegates.observable(emptyList())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBindingUtil: ViewDataBinding = DataBindingUtil.inflate(
                parent.inflate()
                , R.layout.list_item_sports,parent
                ,false)
