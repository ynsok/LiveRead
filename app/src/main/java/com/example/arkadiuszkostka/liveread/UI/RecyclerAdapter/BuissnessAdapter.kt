...
class BuissnessAdapter(private var listner: OnItemPosition): RecyclerView.Adapter<BuissnessAdapter.ViewHolder>() {
    var data: List<BusinessEntry> by Delegates.observable(emptyList())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBindingUtil: ViewDataBinding = DataBindingUtil.inflate(parent.inflate()
                , R.layout.list_item_business, parent
                , false)
