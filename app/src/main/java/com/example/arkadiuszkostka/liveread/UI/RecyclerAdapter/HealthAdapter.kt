...
class HealthAdapter(private var listner: OnItemPosition): RecyclerView.Adapter<HealthAdapter.ViewHolder>() {
    var data: List<HealthEntry>by Delegates.observable(emptyList())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBindingUtil: ViewDataBinding = DataBindingUtil.inflate(parent.inflate()
                , R.layout.list_item_health, parent
                , false)
