...
class ScienceAdapter(private var listner: OnItemPosition): RecyclerView.Adapter<ScienceAdapter.ViewHolder>() {
    var data: List<ScienceEntry> by Delegates.observable(emptyList())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBindingUtil: ViewDataBinding = DataBindingUtil.inflate(
                parent.inflate()
                , R.layout.list_item_science, parent
                , false)
