...
import kotlinx.android.synthetic.main.list_item_keyword.view.*
import kotlin.properties.Delegates

class KeywordAdapter(private var listner: OnItemPosition) : RecyclerView.Adapter<KeywordAdapter.ViewHolder>() {
    var data: List<KeywordEntry> by Delegates.observable(emptyList())
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val dataBindingUtil: ViewDataBinding = DataBindingUtil.inflate(parent.inflate()
                , R.layout.list_item_keyword, parent
                , false)
